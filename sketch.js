...
function setup () {
  ...
  player1.addAnimation("p1d",p1d);
  player1.addAnimation("p1cd",p1cd);
  player1.addAnimation("p1ce",p1ce);

  player2 = createSprite(450,300,15,15);
  player2.addAnimation("p2e",p2e);
  player2.addAnimation("p2cd",p2cd);
  player2.addAnimation("p2ce",p2ce);
...
//movimentação do player1
  if (keyDown("a")) {
      player1.x += -5;
      player1.changeAnimation("p1ce",p1ce);
  }
  if (keyDown("d")) {
    player1.x += 5;
    player1.changeAnimation("p1cd",p1cd);
  }
  if (keyDown("s")) {
    player1.y += 5;
  }
...
//movimentação do player2
  if (keyDown(LEFT_ARROW)) {
    player2.x += -5;
    player2.changeAnimation("p2ce",p2ce);
  }
  if (keyDown(RIGHT_ARROW)) {
    player2.x += 5;
    player2.changeAnimation("p2cd",p2cd);
  }
